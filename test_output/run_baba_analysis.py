...
# The section renderers now live in tradingagents.reporting.html_sections —
# run_batch_analysis.py (a production entry point) used to import them from this
# test script. Re-exported here so this script's own usage is unchanged.
from tradingagents.reporting.html_sections import (  # noqa: F401
...
from tradingagents.reporting.integrity_report import (
...
def generate_html_report(final_state: dict, bundle: DataBundle):
    ...
    integrity_banner = build_integrity_banner(collect_integrity_findings(final_state))
